...
FNAME=input1
EXPECTED=0
./enigma plugboards/I.pb reflectors/I.rf rotors/I.rot rotors/II.rot rotors/III.rot rotors/I.pos < test/input/input1.txt 1> test/output/${FNAME}.txt 2> test/output/${FNAME}_err.txt
RETVAL=$?
